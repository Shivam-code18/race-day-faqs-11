	...
	theme: {
		...
		extend: {
			colors: {
				...
				f1: {
					red: 'hsl(var(--f1-red))',
					orange: 'hsl(var(--f1-orange))',
					teal: 'hsl(var(--f1-teal))',
			...
			keyframes: {
				...
				'speed-glow': {
					'0%, 100%': {
						boxShadow: '0 0 20px hsl(var(--f1-red) / 0.3)'
					},
					'50%': {
						boxShadow: '0 0 40px hsl(var(--f1-red) / 0.6)'
					}
				},
				'slide-expand': {
					'0%': {
			...
			animation: {
				...
				'speed-glow': 'speed-glow 1.5s ease-in-out infinite',
				'slide-expand': 'slide-expand 0.3s ease-out'
			}
		}
	},
